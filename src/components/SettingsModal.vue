...
<template>
  <n-tabs size="large">
    ...
    <n-tab-pane name="about" tab="关于">
      <n-p>
        该站点基于<n-a href="https://github.com/LibreService/my_rime">My Rime</n-a>
        开发<br />
        <!-- This site is based on <n-a href="https://github.com/LibreService/my_rime">My Rime</n-a> -->
      </n-p>
      <n-p style="margin-top: 10px">
        喜欢这个网站的话，可以关注我的
        <n-a href="https://space.bilibili.com/627876">B站账号</n-a> 或者给
        <n-a href="https://github.com/zhou9110/vr_pinyin">Github仓库</n-a>
        点个星标🌟。<br />
        愿意的话也可以打个赏，请我喝杯咖啡或者可乐<br />
        <span>
          <a href="https://ko-fi.com/O4O515LV4N" target="_blank"
            ><img
              height="36"
      ...
      <n-p
        >欢迎提供改进建议以及BUG反馈，您的支持是我最大的动力<span class="nobr"
          >(ò ω ó )</span
        ></n-p
      >
